...
using System.Text;
using IBApi;
using IB_TradingPlatformExtention1;
...
namespace IB_TradingPlatformExtention1
{
    ...
    //! [ewrapperimpl]
        ...
        public virtual void tickOptionComputation(int tickerId, int field, int tickAttrib, double impliedVolatility, double delta, double optPrice, double pvDividend, double gamma, double vega, double theta, double undPrice)
        {
            ...
            client.OnGetTickOptionComputation(tickerId, field, tickAttrib, impliedVolatility, delta, optPrice, pvDividend, gamma, vega, theta, undPrice);
        }
        //! [tickoptioncomputation]
        ...
        {
            Console.WriteLine("ExecDetails. " + reqId + " - " + contract.Symbol + ", " + contract.SecType+", " + contract.Currency+" - " + Util.LongMaxString(execution.PermId) + ", " + execution.ExecId + ", " + Util.IntMaxString(execution.OrderId) + 
